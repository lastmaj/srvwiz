...
public class AppResource {
    ...
    public AppResource(UserService userService, AppRepository appRepository) {
    ...
    public ResponseEntity<App> createApp(@RequestBody App app) throws URISyntaxException {
        ...
        App result = appRepository.save(app.user(userService.getUserWithAuthorities().get()));
    ...
    public List<App> getAllApps() {
        ...
        return appRepository.findByUserIsCurrentUser();
    }
