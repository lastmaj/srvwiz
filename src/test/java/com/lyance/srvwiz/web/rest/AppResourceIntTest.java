...
public class AppResourceIntTest {
    ...
    public void setup() {
        ...
        final AppResource appResource = new AppResource(userService, appRepository);
    ...
    public void createApp() throws Exception {
        ...
        assertThat(testApp.getApiKey()).isEqualTo(DEFAULT_API_KEY);
        assertThat(testApp.isActive()).isEqualTo(DEFAULT_ACTIVE);
    }
    ...
    public void updateApp() throws Exception {
        ...
        assertThat(testApp.getApiKey()).isEqualTo(UPDATED_API_KEY);
        assertThat(testApp.isActive()).isEqualTo(UPDATED_ACTIVE);
    }
