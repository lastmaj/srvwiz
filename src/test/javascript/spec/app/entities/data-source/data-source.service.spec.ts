    ...
    describe('DataSource Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/data-sources';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a DataSource', () => {
                service.create(new DataSource(null)).subscribe(received => {
            ...
            it('should update a DataSource', () => {
                service.update(new DataSource(123)).subscribe(received => {
